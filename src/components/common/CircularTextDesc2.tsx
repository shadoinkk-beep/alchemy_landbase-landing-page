...
const  CircularTextDesc2: React.FC = () => {
    ...
    >
      <div className="container_content !py-0">
        ...
        >
          ...
          <motion.div className="flex flex-col space-y-4 text-right uppercase" variants={fadeUp}>
            <h2 className="text-2xl md:text-3xl font-thin tracking-tight text-gray-900 leading-snug max-w-3xl">
              begins with land that tells a story. <br />
              <div className="font-semibold">
                We shape it with design, purpose, and integrity. <br />
              </div>
              <div className="text-left">a legacy, not just a property.</div>
            </h2>
          </motion.div>
        </motion.div>
...
export default CircularTextDesc2;
